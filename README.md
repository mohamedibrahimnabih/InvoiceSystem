...
To update the database use this command from the Web project folder (replace `InvoiceSystem` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../InvoiceSystem.Infrastructure/InvoiceSystem.Infrastructure.csproj -s InvoiceSystem.Web.csproj
```
