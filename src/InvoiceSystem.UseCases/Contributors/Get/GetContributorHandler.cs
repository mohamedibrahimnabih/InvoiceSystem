using InvoiceSystem.Core.ContributorAggregate;
using InvoiceSystem.Core.ContributorAggregate.Specifications;

namespace InvoiceSystem.UseCases.Contributors.Get;
